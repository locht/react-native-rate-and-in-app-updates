        ...
        public void onActivityResult(Activity activity, int requestCode, int resultCode, Intent intent) {
            if (requestCode == MY_REQUEST_CODE) {
                if (resultCode != RESULT_OK) {
                    System.out.println("Quá trình cập nhật thất bại! mã kết quả: " + resultCode);
    ...
    private void popupSnackbarForCompleteUpdate() {
        Snackbar snackbar =
                Snackbar.make(Objects.requireNonNull(reactContext.getCurrentActivity()).findViewById(android.R.id.content).getRootView(),
                        "Một bản cập nhật vừa được tải xuống.",
                        Snackbar.LENGTH_INDEFINITE);
        snackbar.setAction("Khởi động lại", view -> appUpdateManager.completeUpdate());
        // snackbar.setAction("Khởi động lại", new View.OnClickListener() {
        //     @Override
